...
<Steps>
  <Step title="Step 1: Create a custom component in lib/mdx">
  ...
  <Step title="Step 2: Register it in lib/mdx/index.ts">
    ````ts:lib/mdx/index.ts
  ...
  <Step title="Step 3: Merge custom and built-in components in lib/mdx-components.ts">
  ...
  <Step title="Step 4: Use your custom component in MDX">
    ````md:docs/example.mdx
    <Callout>

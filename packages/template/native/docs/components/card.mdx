...
title: Cards
description:
  A component used to create cards that can be used to display content in a compact and organized
  way.
---
...
<Card title="Simple Card">This is a simple card without an icon or link.</Card>

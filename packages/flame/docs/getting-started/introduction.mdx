...
- **Fast incremental builds** — deterministic bundle hashing and a content-hash build cache: only changed pages recompile, and a prefix or framework change invalidates it automatically
...
- **Subpath-ready** — serve the docs at `/docs` (default), a custom prefix, or the deployment root; links, canonical URLs, search records, and generated nginx rules follow the configuration

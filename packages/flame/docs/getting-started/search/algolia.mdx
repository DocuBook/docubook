...
<div className="pl-4">
<Steps>
  <Step title="Step 1: Visit the DocSearch">
    Visit [DocSearch Application](https://docsearch.algolia.com/apply/ ) to register your
    application.
  </Step>
  <Step title="Step 2: Fill out the form with details about your documentation:">
    - Your website URL - The selectors for headings and content
  </Step>
  <Step title="Step 3: Submit your request. Once approved, Algolia will provide:">
    - Application ID
    - Search API Key
    - Index Name
...
> Pay attention to the <span className="text-red-500 font-bold">highlighted</span> parts of the crawler syntax below—these are the sections you need to modify.

```javascript:index.js showLineNumbers {2-3,6,13,16-17,66} Expandable
new Crawler({

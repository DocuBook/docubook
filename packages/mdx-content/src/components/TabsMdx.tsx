...
export function TabsMdx({
  ...
  return (
    <TabsContext.Provider value={contextValue}>
      <div className={className} {...props} style={{ margin: "1rem 0", ...style }}>
        {children}
      </div>
  ...
  return (
    <button
      ...
      onKeyDown={(e: KeyboardEvent<HTMLButtonElement>) => {
        ...
        if (
          (tabsContext.orientation === "horizontal" && e.key === "ArrowRight") ||
          (tabsContext.orientation === "vertical" && e.key === "ArrowDown")
        ) {
          e.preventDefault();
          moveFocus(1);
        }
        ...
        if (
          (tabsContext.orientation === "horizontal" && e.key === "ArrowLeft") ||
          (tabsContext.orientation === "vertical" && e.key === "ArrowUp")
        ) {
          e.preventDefault();
          moveFocus(-1);
        }
      ...
      style={{
        border: "none",
        borderBottom: active
          ? "2px solid hsl(var(--accent, 200 100% 40%))"
          : "2px solid transparent",
        background: "transparent",
        color: active
          ? "hsl(var(--foreground, 220 30% 15%))"

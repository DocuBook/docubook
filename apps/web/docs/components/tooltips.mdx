...
This a tooltip <Tooltip text="Hover me show on top" tip="npx @docubook/create@latest" side="top" /> and <Tooltip text="Hover me show on bottom" tip="npx @docubook/create@latest" side="bottom" /> thanks you.

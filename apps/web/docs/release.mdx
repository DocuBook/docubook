...
<Release version="2.5.2" date="2026-03-12" title="Fix bug and more improvements">
  <Changes type="added">
    - optimize lucide react import
  </Changes>
  <Changes type="fixed">
    - fix: use position-fixed scroll lock in ImageMdx to prevent mobile flicker
    - fix: keep accordion content mounted with grid-template-rows transition to prevent mobile freeze
    - fix: PreMdx mobile flicker, mobile sidebar body overflow conflict, collapsible animation
    - fix: remove backdrop-blur from scroll-container on mobile, fix GPU layer placement, fade-only sticky animation
  </Changes>
  <Changes type="improved">
    - feat: close mobile navmenu on outside click, Escape key, and add aria-controls
  </Changes>
</Release>

<Release version="2.5.1" date="2026-03-09" title="Dynamic titles on Mobile Toc">
  <Changes type="added">
...
<Release version="2.5.0" date="2026-03-08" title="feat: New Layout, New Components, and UI/UX Improvements">
  <Changes type="added">
    - New Layout for docs
...
<Release version="2.4.0" date="2026-03-01" title="MDX Loading Refactor & Comprehensive Documentation Expansion">
  <Changes type="improved">
...
<Release version="2.3.0" date="2026-02-28" title="feat: Migrate and restructure documentation from contents/docs to docs.">
  <Changes type="improved">
...
<Release version="2.2.0" date="2026-02-24" title="ReleaseMdx enhancements, TOC bug fixes, and UI/UX improvements">
  <Changes type="improved">
    - Modify ReleaseMdx.tsx to render v{version} as an `<h2 id={version}>` with `scroll-m-20` utility instead of a regular `div`.
...
<Release version="2.1.0" date="2026-02-21" title="Upgrade next-mdx-remote">
  <Changes type="fixed">
    - Upgrade to **next-mdx-remote** to `^6.0.0`
  </Changes>
</Release>

<Release version="2.0.0" date="2026-02-09" title="Major Update: Next.js 16, React 19, Tailwind CSS 4, and New Components">
  <Changes type="added">
...
<Release version="1.16.1" date="2025-08-12" title="Icon mapping, code block titles, and code block improvements">
  <Changes type="added">
...
![code block old](/images/codeblock-before.png)

![code block new](/images/codeblock-after.png)

<Release version="1.16.0" date="2025-08-10" title="Accordion context, AccordionGroup component, and improved UI styling">
  <Changes type="added">
...
<Release version="1.15.3" date="2025-08-10" title="feat(accordion): add icon support and update styling">
  <Changes type="added">

...
<Tabs defaultValue="g-default" className="pt-2 pb-1">
  <TabsList>
    <TabsTrigger value="g-default">globals.css</TabsTrigger>
    <TabsTrigger value="o-default">overrides.css</TabsTrigger>
  </TabsList>
  <TabsContent value="g-default">
```css:globals.css
...
<Tabs defaultValue="g-freshlime" className="pt-2 pb-1">
  <TabsList>
    <TabsTrigger value="g-freshlime">globals.css</TabsTrigger>
    <TabsTrigger value="o-freshlime">overrides.css</TabsTrigger>
  </TabsList>
  <TabsContent value="g-freshlime">
```css:globals.css
...
<Tabs defaultValue="g-coffee" className="pt-2 pb-1">
  <TabsList>
    <TabsTrigger value="g-coffee">globals.css</TabsTrigger>
    <TabsTrigger value="o-coffee">overrides.css</TabsTrigger>
  </TabsList>
  <TabsContent value="g-coffee">
```css:globals.css

        ...
        return helpers
          .docsearch({
            recordProps: {
              ...
              // This avoids anchors like #scroll-container from layout wrappers.
          ...
          .map((record) => {
            if (record.anchor !== "scroll-container") return record;

            return {
              ...record,
              anchor: undefined,
              url: record.url?.replace(/#scroll-container$/, ""),
              url_without_anchor: record.url_without_anchor || record.url?.split("#")[0],
            };
          });
      },
    },

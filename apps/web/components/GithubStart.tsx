...
async function GitHubStarButtonInner() {
...
// Fallback shown while fetching GitHub stars (matches button dimensions)
function GitHubStarFallback() {
  return (
    <span className="inline-flex items-center rounded-full px-3 py-1.5 text-sm font-medium text-muted-foreground border">
      <svg
        height="16"
        width="16"
        viewBox="0 0 16 16"
...
export default function GitHubStarButton() {
  return (
    <Suspense fallback={<GitHubStarFallback />}>
      <GitHubStarButtonInner />
    </Suspense>
  );
}

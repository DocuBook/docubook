    ...
    <div className="flex flex-col items-center justify-center px-2 py-8 text-center sm:py-36">
      ...
      <div className="w-full max-w-[800px] pb-8">
        ...
        <p className="mb-8 sm:text-xl text-muted-foreground">
          An open-source alternative to <span className="underline decoration-dotted" >Mintlify, GitBook, and Docusaurus</span>. Just write in MDX — it works with pretty much any React framework.
        </p>
      </div>
